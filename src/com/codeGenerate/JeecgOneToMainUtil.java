...
public class JeecgOneToMainUtil {
	...
	public static void main(String[] args) {
		...
		codeParamEntityIn.setEntityName("JeecgOrderMainSingle");	 //主表[实体名]
		codeParamEntityIn.setEntityPackage("jeecg");	 //主表[包名]
		codeParamEntityIn.setFtlDescription("订单主数据");	 //主表[描述]
		codeParamEntityIn.setFtl_mode(CodeGenerateOneToMany.FTL_MODE_A);//主表[模板 A:明细单页布局显示 B:明细采用Tab布局展现]
		...
		po.setEntityName("JeecgOrderCustomSingle");	 //子表[实体名]
		...
		po2.setEntityName("JeecgOrderProductSingle");			//子表[实体名]
