...
<script type="text/javascript" charset="utf-8">
	...
	function add() {
		...
		document.getElementById("iframe").src = "jeecgOrderMainAction!toJeecgOrderMainMainAdd.action";
	}
	function del() {
	...
	function edit() {
		...
		if (rows.length == 1) {
			...
			iframeDialog.dialog('open');
			document.getElementById("iframe").src = "jeecgOrderMainAction!toJeecgOrderMainMainEdit.action?obid="+rows[0].obid;
		} else {
