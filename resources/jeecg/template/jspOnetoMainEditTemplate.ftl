                ...
                <tbody>
                  <tr bgcolor="#CCE6D1">
					...
					<tr>
                   	 	...
                   	 	<td align="left">${po.filedComment}</td>
                    	<td align="left">
                    	...
                    	<#else>
                    	<input name="${po.fieldName}" type="text" class="${po.classType}" maxlength="${po.charmaxLength}" value="${'$'}{${entityName?uncap_first}Page.${po.fieldName} }" data-options=""/>
                    	</#if>
                    	</td>
					<#if (po_index+1)%4==0>
					</tr>
                    ...
                    <table border="0" cellpadding="2" cellspacing="0" id="${sub.entityName?uncap_first}_table">
                        <tr bgcolor="#E6E6E6">
						  ...
						  <#list sub.subColums as po>
							  ...
							  <#if check==0>
							  <td align="left" bgcolor="#EEEEEE">${po.filedComment}</td>
							  </#if>
                          </#list>
                        </tr>
                        <tr>
